...
function Footer() {
  return (
    <footer id="foot" className="footer row d-flex flex-wrap align-content-center justify-content-center">
      <div className="col-3">
        ...
        <button className="btn btn-outline-light btn-footer">Código do serviço</button>
